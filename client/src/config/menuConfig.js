...
export const menuConfig = [
    ...
    },
    {
        ...
        children: [
            ...
            { id: 'customers-batch-delete', label: 'Eliminación Masiva de Clientes', permission: 'manage_customers_batch_delete', hideInMenu: true },
        ]
    },
    {
        id: 'compras',
        ...
        children: [
            ...
            { id: 'compras-quedan', label: 'Quedan', path: '/compras/quedan', icon: FileSignature, permission: 'manage_purchase_checks' },
