...
const PurchaseReport = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            setPdfUrl(url);
            toast.success('Reporte de compras generado correctamente');
        } catch (error) {
    ...
    const handleDownload = () => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', `Reporte_Compras_${filters.start_date}_al_${filters.end_date}.pdf`);
    ...
    return (
        <ReportLayout
            ...
            subtitle="Análisis detallado de compras de productos e inventario."
            category="Compras"
            pdfUrl={pdfUrl}
