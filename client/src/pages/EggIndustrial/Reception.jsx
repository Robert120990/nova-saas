        ...
        try {
            ...
            autoTable(doc, {
                ...
                body: [
                    ...
                    ['Talla / Clasificación:', rm.egg_size || 'L', 'Inspector / Operador:', rm.operator_name || 'N/A'],
                    ['Total Cajas Recibidas:', `${rm.total_boxes || 0} cajas`, 'Total Peso Neto:', `${parseFloat(rm.weight_lbs || 0).toLocaleString()} Lbs`]
                ]
            });
