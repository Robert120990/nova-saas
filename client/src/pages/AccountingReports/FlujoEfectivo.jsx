...
const FlujoEfectivo = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            const response = await axios.get('/api/accounting/reports/flujo-efectivo', {
                params,
                responseType: 'blob'
            });
            ...
            setPdfUrl(url);
            toast.success('Estado de flujo de efectivo generado correctamente');
        } catch (error) {
            console.error('Error generating report:', error);
            toast.error('Error al generar el estado de flujo de efectivo');
        } finally {
    ...
    const handleDownload = () => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', `Flujo_Efectivo_${fileSuffix}.pdf`);
    ...
    const handleExportExcel = async () => {
        try {
            ...
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', `Flujo_Efectivo_${filters.year}_Mes_${filters.month}.xlsx`);
            document.body.appendChild(link);
            link.click();
            link.remove();
    ...
    return (
        <ReportLayout
            ...
            subtitle="Clasificación de entradas y salidas de efectivo en actividades de operación, inversión y financiamiento."
