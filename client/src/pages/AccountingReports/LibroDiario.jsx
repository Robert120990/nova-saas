...
const LibroDiario = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            setPdfUrl(url);
            toast.success('Libro diario generado correctamente');
        } catch (error) {
            console.error('Error generating report:', error);
            toast.error('Error al generar el libro diario');
        } finally {
    ...
    const handleDownload = () => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', `Libro_Diario_${filters.start_date}_al_${filters.end_date}.pdf`);
