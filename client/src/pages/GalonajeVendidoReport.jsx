...
const GalonajeVendidoReport = () => {
    ...
    const handleDownload = () => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', `Galonaje_Vendido_${filters.start_date}.pdf`);
    ...
    return (
        <ReportLayout
            ...
            subtitle="Reporte de galonaje vendido por tipo de combustible, comparando lecturas vs ventas."
            category="Gasolinera"
            pdfUrl={pdfUrl}
...
export default GalonajeVendidoReport;
