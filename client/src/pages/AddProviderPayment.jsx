                ...
                <div className="p-4 md:p-8 grid grid-cols-1 sm:grid-cols-2 gap-8 text-sm italic">
                    <div className="space-y-6">
                        <div>
                            ...
                            <span className="text-lg font-black text-slate-800 underline tracking-tighter decoration-rose-200"><Money value={doc.total_original || 0} /></span>
                        </div>
                        <div>
                            <span className="text-[10px] font-black text-rose-400 uppercase tracking-widest block mb-1">Saldo Pendiente</span>
                            <span className="text-lg font-black text-rose-600 underline tracking-tighter decoration-rose-500"><Money value={doc.saldo_pendiente || 0} /></span>
                        </div>
                    </div>
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 italic">
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <span className="text-3xl font-black text-slate-900 tracking-tighter"><Money value={pay.monto || 0} /></span>
                                </div>
                            </div>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {(histData.payments || []).map(p => (
                                    <tr key={p.id} className="hover:bg-rose-50/20 transition-colors group">
                                        ...
                                        <td className="px-8 py-4 text-right font-black text-slate-900 tracking-tighter text-xs underline decoration-rose-100"><Money value={p.monto || 0} /></td>
                                        ...
                                        <td className="px-8 py-4">
                                            <div className="flex items-center justify-end gap-1">
                                                <button onClick={() => setViewPaymentId(p.id)} title="Ver Detalle" className="p-1.5 hover:bg-white text-slate-600 hover:text-rose-600 rounded-lg transition-all shadow-sm border border-transparent hover:border-slate-100"><Eye size={14} /></button>
                                                <button onClick={() => handlePrintPDF(p.id)} title="Imprimir Comprobante" className="p-1.5 hover:bg-white text-slate-600 hover:text-rose-600 rounded-lg transition-all shadow-sm border border-transparent hover:border-slate-100"><Printer size={14} /></button>
                                                ...
                                                <button onClick={() => handleDelete(p.id)} title="Eliminar Pago" className="p-1.5 hover:bg-white text-slate-600 hover:text-rose-600 rounded-lg transition-all shadow-sm border border-transparent hover:border-slate-100"><Trash2 size={14} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
