...
const QuedanReport = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            setPdfUrl(url);
            toast.success('Reporte de quedanes generado correctamente');
        } catch (error) {
            console.error('Error generating report:', error);
            toast.error('Error al generar el reporte de quedanes');
        } finally {
    ...
    const handleDownload = () => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', `Reporte_Quedanes_${filters.start_date}_al_${filters.end_date}.pdf`);
    ...
    const handleExportExcel = async () => {
        try {
            ...
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', `Reporte_Quedanes.xlsx`);
            document.body.appendChild(link);
            link.click();
            link.remove();
