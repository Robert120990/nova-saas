...
const FuelSalesSummaryReport = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            const response = await axios.get('/api/gas-station/reports/fuel-sales-summary/pdf', {
                params,
                responseType: 'blob'
            });
            ...
            setPdfUrl(url);
            toast.success('Reporte de resumen GLN vendidos generado');
        } catch (error) {
    ...
    const handleDownload = () => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', `Resumen_GLN_Vendidos_${filters.start_date}_al_${filters.end_date}.pdf`);
    ...
    const handleExportExcel = async () => {
        try {
            ...
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', `Resumen_GLN_Vendidos.xlsx`);
            document.body.appendChild(link);
            link.click();
            link.remove();
    ...
    return (
        <ReportLayout
            title="Resumen GLN Vendidos"
            subtitle="Reporte de galones vendidos por producto y fecha."
            category="Gasolinera"
            pdfUrl={pdfUrl}
...
export default FuelSalesSummaryReport;
