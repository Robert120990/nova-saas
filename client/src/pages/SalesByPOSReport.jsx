...
const SalesByPOSReport = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            toast.error('Error al generar el reporte de ventas por POS');
        } finally {
    ...
    const handleDownload = () => {
        ...
        link.href = pdfUrl;
        link.setAttribute('download', `Reporte_Ventas_POS_${filters.start_date}.pdf`);
    ...
    const handleExportExcel = async () => {
        try {
            ...
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', `Ventas_POS.xlsx`);
            document.body.appendChild(link);
            link.click();
            link.remove();
    ...
    return (
        <ReportLayout
            title="Ventas por POS"
            subtitle="Resumen de facturación agrupado por Terminal Punto de Venta (POS)."
            category="Ventas"
            pdfUrl={pdfUrl}
...
export default SalesByPOSReport;
