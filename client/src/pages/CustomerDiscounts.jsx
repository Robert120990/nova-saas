                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50/50">
                                <th className="px-4 py-2 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100 italic">Sucursal</th>
                                <th className="px-4 py-2 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100">Cliente</th>
                                <th className="px-4 py-2 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100">Producto / Código</th>
                                <th className="px-4 py-2 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100 text-center">Tipo</th>
                                <th className="px-4 py-2 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100 text-right">Valor Descuento</th>
                                <th className="px-4 py-2 text-[10px] font-black text-slate-400 uppercase tracking-widest border-b border-slate-100 text-center uppercase tracking-tighter">Acciones</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-50">
                            {isLoadingDiscounts ? (
                                <tr><td colSpan="6" className="px-4 py-10 text-center"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-600 mx-auto"></div></td></tr>
                            ) : filteredDiscounts.length > 0 ? (
                                filteredDiscounts.map((d) => (
                                    <tr key={d.id} className="hover:bg-slate-50/50 transition-colors group">
                                        <td className="px-4 py-1">
                                            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-tighter bg-slate-100 px-2 py-0.5 rounded-full">{d.branch_name}</span>
                                        </td>
                                        <td className="px-4 py-1">
                                            <span className="text-xs font-bold text-slate-900">{d.customer_name}</span>
                                        </td>
                                        <td className="px-4 py-1">
                                            <div className="flex flex-col">
                                                <span className="text-xs font-bold text-slate-800">{d.product_name}</span>
                                                <span className="text-[10px] font-mono text-slate-400">#{d.product_code}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-4 py-1 text-center">
                                            <button 
                                                ...
                                                className="p-1 text-rose-500 hover:bg-rose-50 rounded-lg transition-all active:scale-90"
                                            >
                                                <Trash2 size={14} />
                                            </button>
                                        </td>
                                ...
                                <tr>
                                    <td colSpan="6" className="px-4 py-10 text-center text-slate-400 opacity-50">
