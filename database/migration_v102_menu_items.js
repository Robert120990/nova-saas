...
const MENU_ITEMS = [
  ...
  { id: 'pos-cierre', label: 'Corte de Caja', path: '/ventas/cierre', icon: 'Calculator', parent: 'ventas', permission: 'manage_cash_closure', order: 3 },
  { id: 'ventas-descuentos-parent', label: 'Descuentos y Promociones', icon: 'BadgePercent', parent: 'ventas', order: 4 },
  { id: 'ventas-combos', label: 'Combos de Productos', path: '/ventas/combos', icon: 'Package', parent: 'ventas-descuentos-parent', permission: 'manage_combos', order: 1 },
  { id: 'ventas-descuentos', label: 'Descuentos por Cliente', path: '/ventas/descuentos', icon: 'Tag', parent: 'ventas-descuentos-parent', permission: 'manage_customer_discounts', order: 2 },
  { id: 'ventas-reglas-descuento', label: 'Reglas de Descuento', path: '/ventas/reglas-descuento', icon: 'Tag', parent: 'ventas-descuentos-parent', permission: 'manage_discount_rules', order: 3 },
  { id: 'ventas-promociones', label: 'Promociones', path: '/ventas/promociones', icon: 'Sparkles', parent: 'ventas-descuentos-parent', permission: 'manage_sales_promotions', order: 4 },
  { id: 'ventas-combustibles', label: 'Precios de Combustible', path: '/ventas/combustibles', icon: 'Banknote', parent: 'ventas', permission: 'manage_fuel_prices', order: 5 },
  { id: 'ventas-eventos-parent', label: 'Eventos MH', icon: 'FileCheck', parent: 'ventas', order: 6 },
  { id: 'ventas-contingencia', label: 'Contingencia DTE', path: '/ventas/contingencia', icon: 'AlertTriangle', parent: 'ventas-eventos-parent', permission: 'manage_dte_contingency', order: 1 },
  { id: 'ventas-retorno', label: 'Retorno / ERET', path: '/ventas/retorno', icon: 'Undo2', parent: 'ventas-eventos-parent', permission: 'manage_dte_return', order: 2 },
