...
async function resendGasDelivery(deliveryId, companyId) {
    ...
    const rrsIdEmpresa = empresaRows[0]?.setting_value || '006';
...
(async () => {
    try {
        console.log('=== REENVIANDO REMESAS A RRS (RAUL RAFAEL SOSA - SHELL CHALCHUAPA) ===');
        ...
        // 104 = 18/09, 108 = 19/09, 111 = 21/09 (contiene remesas del 20/09 y 21/09)
        const gasDeliveryIds = [104, 108, 111];
        ...
        // 86 = 18/09, 88 = 19/09, 89 = 20/09
        const salesDeliveryIds = [86, 88, 89];
        ...
        const [movs] = await rrs.query(
            `SELECT id, id_empresa, llave, documento, numero_cuenta, concepto, cargo, fecha, monto 
             ...
             WHERE llave IN ('006-104', '006-108', '006-111', '006-86', '006-88', '006-89')
        ...
        const closeoutIds = ['006-347', '006-353', '006-357'];
