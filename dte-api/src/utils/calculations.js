...
function calculateItem(item, tipoDte = '01', ivaRate = 13) {
    ...
    if (tipoDte === '01') {
        ...
        iva = isGravado ? round(ventaGravada * rate) : 0;
    }
...
function calculateTotals(items, taxes = [], tipoDte = '01', generalDiscount = 0, ivaRate = 13, explicitPercentage = null) {
    ...
    if (tipoDte === '01') {
        ...
        // En CCF 03, el IVA se liquida sobre la base gravada neta remanente
        finalIva = round(Math.max(0, totalGravada - descuGravada) * rate);
